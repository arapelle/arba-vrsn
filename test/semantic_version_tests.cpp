...
{
    vrsn::semantic_version version(1, 2, 3);
...
{
    vrsn::semantic_version version(1, 2, 3, "alpha.1");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
...
{
    vrsn::semantic_version version(1, 2, 3, "alpha.1", "specific-build");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
    ASSERT_EQ(version.pre_release(), "alpha.1");
...
{
    vrsn::tri_version version_core(1, 2, 3);
    vrsn::semantic_version version(version_core, "pre-release.1");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
...
{
    vrsn::tri_version version_core(1, 2, 3);
    vrsn::semantic_version version(version_core, "alpha.1", "specific-build");
    ASSERT_EQ(version.major(), 1);
    ASSERT_EQ(version.minor(), 2);
    ASSERT_EQ(version.patch(), 3);
    ASSERT_EQ(version.pre_release(), "alpha.1");
...
TEST(semantic_version_tests, semantic_version_constructor__x_y_z_bpr_bm__expect_exception)
{
    try
    {
        vrsn::semantic_version version(1, 2, 3, "alpha_1", "specific-build");
        FAIL();
    }
    catch (...)
    {
...
TEST(semantic_version_tests, semantic_version_constructor__x_y_z_pr_bbm__expect_exception)
{
    try
    {
        vrsn::semantic_version version(1, 2, 3, "alpha.1", "specific_build");
        FAIL();
    }
    catch (...)
    {
                          ...
                          std::string_view build_metadata = "")
{
    ...
    vrsn::semantic_version semver(version_strv);
...
TEST(semantic_version_tests, semantic_version_constructor__bad_sv__expect_exception)
{
    try
    {
        vrsn::semantic_version version_1("0.1.2-alpha_0+specific-build");
        FAIL();
    }
    catch (const std::exception&)
    {
    ...
    try
    {
        vrsn::semantic_version version_2("0.1.2-alpha-0+specific_build");
        FAIL();
    }
    catch (const std::exception&)
    {
    ...
    try
    {
        vrsn::semantic_version version_3("0.1.2-alpha.bad_item+item.specific_build");
        FAIL();
    }
    catch (const std::exception&)
    {
    ...
    try
    {
        vrsn::semantic_version version_4("0.1.2-alpha-0+item.specific_build");
        FAIL();
    }
    catch (const std::exception&)
    {
...
{
    vrsn::semantic_version version(0, 1, 2);
    ASSERT_EQ(version.core(), vrsn::tri_version(0, 1, 2));
    const vrsn::semantic_version c_version(0, 1, 2);
    ASSERT_EQ(c_version.core(), vrsn::tri_version(0, 1, 2));
}

TEST(semantic_version_tests, operator_eq__normal__no_exception)
{
    ASSERT_EQ(vrsn::semantic_version(0, 1, 2, "alpha.1", "build-title"),
              vrsn::semantic_version(0, 1, 2, "alpha.1", "build-title"));
    ASSERT_EQ(vrsn::semantic_version(0, 1, 2, "alpha.1", "build-title"), vrsn::semantic_version(0, 1, 2, "alpha.1"));
    ASSERT_EQ(vrsn::semantic_version(0, 1, 2, "alpha.1", "build-title"),
              vrsn::semantic_version("0.1.2-alpha.1+build-title"));
    ASSERT_EQ(vrsn::semantic_version(0, 1, 2, "alpha.1", "build-title"), vrsn::semantic_version("0.1.2-alpha.1"));
}
...
{
    ASSERT_NE(vrsn::semantic_version(0, 1, 2, "alpha.1", "build-title"),
              vrsn::semantic_version(0, 1, 2, "alpha.2", "build-title"));
    ASSERT_NE(vrsn::semantic_version(0, 1, 3, "alpha.1", "build-title"),
              vrsn::semantic_version(0, 1, 2, "alpha.1", "build-title"));
}

TEST(semantic_version_tests, operator_lt__normal__no_exception)
{
    EXPECT_TRUE(vrsn::semantic_version("1.2.3") < vrsn::semantic_version("1.2.4"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-1234") < vrsn::semantic_version("1.2.3-123a"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-alpha.99") < vrsn::semantic_version("1.2.3-alpha.00a"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-alpha.9999") < vrsn::semantic_version("1.2.3-alpha.00a"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-alpha.7") < vrsn::semantic_version("1.2.3-alpha.22"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-alpha.7") < vrsn::semantic_version("1.2.3-alpha.77"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-alpha.1") < vrsn::semantic_version("1.2.3-alpha.-v"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-1.4") < vrsn::semantic_version("1.2.3-alpha.2"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-alpha.beta.4") < vrsn::semantic_version("1.2.3-alpha.gamma.2"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-1456") < vrsn::semantic_version("1.2.3--lol"));
    EXPECT_TRUE(vrsn::semantic_version("1.2.3-1456") < vrsn::semantic_version("1.2.3-1456.123"));
    vrsn::semantic_version va("1.2.3-045a");
    vrsn::semantic_version vb("1.2.3-145a");
    EXPECT_TRUE(va < vb);

    EXPECT_FALSE(vrsn::semantic_version("1.2.3-alpha.22") < vrsn::semantic_version("1.2.3-alpha.7"));
    EXPECT_FALSE(vrsn::semantic_version("1.2.3-alpha.77") < vrsn::semantic_version("1.2.3-alpha.7"));
    EXPECT_FALSE(vrsn::semantic_version("1.2.3-1456.123") < vrsn::semantic_version("1.2.3-1456.123"));
    EXPECT_FALSE(vrsn::semantic_version("1.2.3--lol") < vrsn::semantic_version("1.2.3-1456"));
    EXPECT_FALSE(vrsn::semantic_version("1.2.3-alpha.gamma") < vrsn::semantic_version("1.2.3-alpha.beta"));
    EXPECT_FALSE(vrsn::semantic_version("1.2.3-alpha.beta") < vrsn::semantic_version("1.2.3-alpha"));
    EXPECT_FALSE(vrsn::semantic_version("1.2.3-alpha.7") < vrsn::semantic_version("1.2.3-alpha.6"));
    EXPECT_FALSE(vrsn::semantic_version("1.2.3") < vrsn::semantic_version("1.2.3-alpha.6"));
}

TEST(semantic_version_tests, operator_le__normal__no_exception)
{
    ASSERT_TRUE(vrsn::semantic_version("1.2.3") <= vrsn::semantic_version("1.2.3"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3") <= vrsn::semantic_version("1.2.4"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-alpha.1") <= vrsn::semantic_version("1.2.3-alpha.2"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-1.4") <= vrsn::semantic_version("1.2.3-alpha.2"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-alpha.beta.4") <= vrsn::semantic_version("1.2.3-alpha.gamma.2"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-1456") <= vrsn::semantic_version("1.2.3--lol"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-1456") <= vrsn::semantic_version("1.2.3-1456.123"));
}

TEST(semantic_version_tests, operator_gt__normal__no_exception)
{
    ASSERT_TRUE(vrsn::semantic_version("1.2.3--lol") > vrsn::semantic_version("1.2.3-1456"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-alpha.gamma") > vrsn::semantic_version("1.2.3-alpha.beta"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-alpha.beta") > vrsn::semantic_version("1.2.3-alpha"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3-alpha.7") > vrsn::semantic_version("1.2.3-alpha.6"));
    ASSERT_TRUE(vrsn::semantic_version("1.2.3") > vrsn::semantic_version("1.2.3-alpha.6"));

    ASSERT_FALSE(vrsn::semantic_version("1.2.3-1456.123") > vrsn::semantic_version("1.2.3-1456.123"));
    ASSERT_FALSE(vrsn::semantic_version("1.2.3") > vrsn::semantic_version("1.2.4"));
    ASSERT_FALSE(vrsn::semantic_version("1.2.3-alpha.1") > vrsn::semantic_version("1.2.3-alpha.2"));
    ASSERT_FALSE(vrsn::semantic_version("1.2.3-1.4") > vrsn::semantic_version("1.2.3-alpha.2"));
    ASSERT_FALSE(vrsn::semantic_version("1.2.3-alpha.beta.4") > vrsn::semantic_version("1.2.3-alpha.gamma.2"));
    ASSERT_FALSE(vrsn::semantic_version("1.2.3-1456") > vrsn::semantic_version("1.2.3--lol"));
    ASSERT_FALSE(vrsn::semantic_version("1.2.3-1456") > vrsn::semantic_version("1.2.3-1456.123"));
}
...
{
    static constexpr vrsn::semantic_version version_1(0, 1, 2, "0.0", "specific-build");
    ...
    static constexpr vrsn::semantic_version version_2("98.7.66-0.0+specific-build");
